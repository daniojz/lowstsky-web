    ...
    <>
      <div className='typeBeatsListContent'>
        <div className='typeBeatsButtons'>
          ...
          <button
            className={`typeBeatButtonEdit ${
              listState === 1
                ? 'typeBeatButtonEdit-active'
                : 'typeBeatButtonEdit-normal'
            }`}
        ...
        <div
          className={`typeBeatsList ${
            listState === 1 ? 'typeBeatsList-active' : 'typeBeatsList-normal'
          }`}
        >
          {typeBeats != null
            ? typeBeats.map((beat) => renderBeat(beat.data(), beat.id))
            : 'A ocurrido un error'}
        </div>
      </div>
    </>
