...
const DELETE_SUCCESS = "PUT_SUCCESS";
const DELETE_FAILURE = "PUT_FAILURE";
...
export function typeBeats(state = initialState, action) {
  switch (action.type) {
    ...
    case PUT_FAILURE:
      return { ...state, loading: false, typeBeatAdded: null, error: action.error  };

    case DELETE_SUCCESS:
      return { ...state, loading: false, typeBeatsDeleted: action.typeBeatsDeleted};
    case DELETE_FAILURE:
      return { ...state, loading: false, typeBeatsDeleted: null, error: action.error};
