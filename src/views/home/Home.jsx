        ...
        <div className="homeContent">
          ...
          >
            <span onClick={logoButtonClickHandler} className="">
              <img className="homeSection-icon" src="/lowstsky-icon.png"></img>
            </span>
          </div>
          <div
          ...
          >
            ...
            <div className="presentationTextContent">
              <p>
                ...
                Provident qui officiis totam ea. Vel, omnis ad quas atque rerum
                vitae, cum sit animi modi earum minus recusandae esse officiis
                odit? /n asodfjasodifj Lorem ipsum dolor sit amet, consectetur
                adipisicing elit. Provident qui officiis totam ea. Vel, omnis ad
                quas atque rerum vitae, cum sit animi modi earum minus
                recusandae esse officiis odit? /n asodfjasodifj
              </p>
            </div>
          </div>
        </div>
